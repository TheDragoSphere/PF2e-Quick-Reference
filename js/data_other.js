data_other = [
    {
        title: "Aid",
        icon: "one-action-plus-react",
        subtitle: "Help an ally with a check/roll",
    ...
    },
    {
        ...
        icon: "one-action",
        subtitle: "(secret)",
        description: "Remember a bit of knowledge about the subject.",
    ...
    },
    {
        ...
        icon: "one-action",
        subtitle: "Diplomacy",
        description: "Make a request of a friendly or helpful creature.",
        ...
        bullets: [
            ...
            "<b>Critical Failure:</b> Not only does the target refuse the request, but their attitude toward you decreases by one step due to the temerity of the request."
        ]
    },
    {
        title: "Perform",
        ...
        description: "Make a brief performance (song, dance, joke).",
        reference: "Core Rulebook pg 250.",
        bullets: [
    ...
    },
    {
        ...
        icon: "one-action",
        subtitle: "Nature",
        description: "Issue an order to an animal.",
        ...
        bullets: [
            ...
            "<b>Critical Failure:</b> The animal misbehaves or misunderstands, and it takes some other action determined by the GM."
        ]
    },
]
